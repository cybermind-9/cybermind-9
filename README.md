# Hello, I'm Tufan
<a href="https://www.linkedin.com/in/pande-tufan" target="_blank" rel="noopener noreferrer">
...
| Localhost Network Penetration Testing Lab   | <a href="https://github.com/Itsme-crypto/localhost-network-pentest-lab">Git Repository </a>| Reconnaissance & Enumeration, Vulnerability Assessment, Exploitation & Attack Execution, Post-Exploitation, Metasploit Framework, Deep packet inspection.   |
...
| Network Traffic Monitoring and Attack Detection using Snort |<a href="https://github.com/Itsme-crypto/Snort-Network-Monitoring/blob/main/README.md">Git Repository </a> | Network Traffic Analysis,  Intrusion Detection and Snort Configuration, Offensive Security Techniques, Linux System Administration,  Logging & Alert Management.  |
